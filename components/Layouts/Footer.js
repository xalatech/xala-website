        ...
        return (
            <footer className="footer-area">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="single-footer-widget">
                                ...
                                <ul className="get-in-touch">
                                    ...
                                    <li><i className="icofont-envelope"></i> hello@pungent.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="copyright-area">
                    <div className="container">
                        <p>&copy; Copyright {currentYear} Pungent. All Rights Reserved By <a href="https://envytheme.com" target="_blank">EnvyTheme</a>.</p>
                    </div>
                </div>
            </footer>
        );
